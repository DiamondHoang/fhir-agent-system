...
def _get_client():
    ...
    from app.config.settings import QDRANT_MODE, QDRANT_PATH, QDRANT_URL
...
def _ensure_index():
    ...
    from app.models.shared_client import embed_text
    from app.config.settings import QDRANT_COLLECTION, EMBEDDING_URL, EMBEDDING_MODEL, EMBEDDING_TIMEOUT
